_base_ = [
    "../../../_base_/models/dinus_segvit_vitb14.py",
...
num_classes = 5
checkpoint_path = "{{$EXPERIMENTS_DIR:/}}/vitb14_dinus_13m/20241205-125614-472926/pretrain/eval/training_1999999/teacher_checkpoint.pth"
