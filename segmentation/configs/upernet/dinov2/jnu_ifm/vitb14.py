_base_ = [
    "../../../../_base_/models/dinov2_vitb14.py",
...
num_classes = 5
checkpoint_path = (
    "{{$EXPERIMENTS_DIR:/}}/vitb14_dinov2_LVD142M/20250205-0000/pretrain/dinov2_vitb14_reg4_pretrain_pos_embed_257.pth"
)
